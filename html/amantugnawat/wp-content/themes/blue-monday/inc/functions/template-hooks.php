    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            <span><?php if(is_home() || is_front_page()): ?>
                - <?php echo __('Built with','blue-monday'); ?> <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'blue-monday' ) ); ?>"><?php printf( esc_html( '%s', 'blue-monday' ), 'WordPress' ); ?></a> <span><?php _e('and','blue-monday'); ?></span> <a href="<?php echo esc_url( __( 'http://deucethemes.com/', 'blue-monday' ) ); ?>"><?php printf( esc_html( '%s', 'blue-monday' ), 'Deuce Themes' ); ?></a>   
            <?php endif; ?>
            </span>
        </div>
    </div>
